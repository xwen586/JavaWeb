...
public class HTTPServer1 {
	...
	public static void service(Socket socket) throws Exception {
		...
		System.out.println("uri:" + uri ); //  打印URI数据
		...
		if (uri.indexOf("servlet") != -1) {
			...
			System.out.println("调用 servlet：" + servletName);
		...
		System.out.println("path=" + path); // 打印PATH数据

		InputStream in = HTTPServer1.class.getResourceAsStream(path);
...
/****************************************************
 * 作者：孙卫琴 * 来源：<<Tomcat与Java Web开发技术详解>> * 技术支持网址：www.javathinker.org *
 ***************************************************/
